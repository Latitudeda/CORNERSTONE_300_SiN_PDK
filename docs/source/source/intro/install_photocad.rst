Install PhotoCAD and CORNERSTONE SIN300nm PDK
=======================================
...
To install corner_stone_pdk_SIN300nm package to **PhotoCAD**, extract ``corner_stone_pdk_SIN300nm.zip`` to the project folder (normally it should be named ``layout1001``).
